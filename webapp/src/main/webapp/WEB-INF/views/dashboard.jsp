...
<body id="dashboard">
		...
		<div class="mdl-layout mdl-js-layout">
			<header class="layout_header">
				<div class="mdl-layout__header-row">
					<span class="mdl-layout-title"> <a href="dashboard">Computer
							Database</a></span>
					<form id="search-form" action="#" method="GET">
						...
						<div class="mdl-textfield mdl-js-textfield">
							<input class="mdl-textfield__input" name="search" type="text"
								id="search"> <label class="mdl-textfield__label"
					...
					<div class="navigation mdl-navigation">
						...
						<sec:authorize access="isAnonymous()">
							<a class="waves-effect waves-light btn"
								href="<c:url value="/addUser" />">Register</a>
							<a class="waves-effect waves-light btn"
	...
	<section id="main">
		<div class="sidebar">
			<div class="panel-icons">
				<a href="dashboard?mylocale=en"><img alt="English"
					class="picto-flag"
					src="<c:url value="/resources/img/flag-en.png"/>"></a> <a
					href="dashboard?mylocale=fr"><img alt="French"
					class="picto-flag"
					src="<c:url value="/resources/img/flag-fr.png"/>"></a>
			</div>
			<div class="menu">
				<ul class="dashboard-menu">
					<li id="menu_dashboard"
						class="mdl-menu__item mdl-menu__item--full-bleed-divider"><i
						class="material-icons">dvr</i><span>Computer</span></li>
					<li id="menu_dashboard_user"
						class="mdl-menu__item mdl-menu__item--full-bleed-divider"><i
						class="material-icons">account_circle</i><span>Users</span></li>
				</ul>
			</div>
		</div>
		<div class="card mdl-shadow--2dp">
			...
			<c:set value='sortCol mdl-data-table__cell--non-numeric'
				var="sortColTableCell" />
			<c:set
				value='sortCol mdl-data-table__cell--non-numeric mdl-data-table__header--sorted-ascending'
				var="sortColTableCellSortedAscending" />
			...
			<div class="container" style="margin-top: 10px;">
				<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp"
					...
					<thead>
						<tr>
							<th class='sortCol mdl-data-table__cell--non-numeric
								<c:choose> 
						<c:when test="${model.options.column == 'name'}"><c:out value=" mdl-data-table__header--sorted-ascending"/></c:when>
						<c:otherwise><c:out value="" /></c:otherwise>
							...
							<th class='sortCol mdl-data-table__cell--non-numeric
								<c:choose>
						<c:when test="${model.options.column == 'introduced'}"><c:out value=" mdl-data-table__header--sorted-ascending"/></c:when>
						<c:otherwise><c:out value=""/></c:otherwise>
						</c:choose>'><a
							...
							<th class='sortCol mdl-data-table__cell--non-numeric
								<c:choose>
						<c:when test="${model.options.column == 'discontinued'}"><c:out value=" mdl-data-table__header--sorted-ascending"/></c:when>
						<c:otherwise><c:out value=""/></c:otherwise>
						</c:choose>'><a
							...
							<th class='sortCol mdl-data-table__cell--non-numeric
								<c:choose>
						<c:when test="${model.options.column == 'co.name'}"><c:out value=" mdl-data-table__header--sorted-ascending"/></c:when>
						<c:otherwise><c:out value=""/></c:otherwise>
						</c:choose>'><a
							...
							<tr class="rowComputer" id="${ computerDto.id }">
								...
								<td class="labelName  mdl-data-table__cell--non-numeric">
									<div class="delete-checkbox-panel">
										<label
											class="cb mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect"
											for="checkbox-${ computerDto.id }"> <input
											type="checkbox" id="checkbox-${ computerDto.id }"
											class="cb mdl-checkbox__input" name="cb"
											value="${ computerDto.id }">
										</label>
									</div> <span>${ computerDto.name }</span>
								</td>
								...
								<td class="mdl-data-table__cell--non-numeric"><span>${ computerDto.companyName }</span>
									<div class="delete-panel">
										...
										<button id="button-delete-computer"
											class="mdl-button mdl-js-button"
											onclick="$.fn.toggleEditMode();">
											<i class="material-icons">delete</i>
										</button>
										<button id="${ computerDto.id }"
											class="mdl-button mdl-js-button button-edit-computer">
	...
	<div class="dashboard-fab dashboard-fab-add">
		<button id="button-add-computer"
			class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored">
			<i class="material-icons">add</i>
		</button>
	</div>
	<div class="dashboard-fab dashboard-fab-open-delete">
		<button id="button-open-delete"
			class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored">
			<i class="open-delete material-icons">delete</i> <i
				class="open-clear material-icons">clear</i>
		</button>
	</div>
	<div class="dashboard-fab dashboard-fab-check-all">
		<button id="button-check-all"
			class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored">
	...
	<div class="dashboard-fab dashboard-fab-delete">
		<button id="button-delete-computer"
			class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored red"
		...
		<div class="footer-panel">
			...
			<div class="number-page-panel" role="group">
              ...
              <c:out value='class=active'/>
							...
							id="nbObject${ nbObject }"
							class='mini-fab mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab'
