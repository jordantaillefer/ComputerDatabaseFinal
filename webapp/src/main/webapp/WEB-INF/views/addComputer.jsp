	...
	<div class="main-panel">
		<div class="add-panel">
			...
			<form id="form-add" action="addComputer" method="post">
				<div class="title-add">
					<span id="text-title-add">Add computer</span>
				</div>
				<input type="hidden" name="${_csrf.parameterName}" id="_csrf"
					value="${_csrf.token}" />
				<div class="input-field">
					<input type="text" name="name" id="name"> <label
						for="name">Computer Name</label>
				</div>
				<div class="input-field">
					<input type="text" class=" datepicker " id="introduced"
						name="introduced"> <label for="introduced">Date
						Introduced</label>
				</div>
				<div class="input-field">
					<input type="text" class="datepicker" id="discontinued"
						name="discontinued"> <label for="discontinued">Date
						Discontinued</label>
				</div>
				<div class="input-field">
					<select name="companyId" id="companyId">
						<option value="0">No associated company</option>
